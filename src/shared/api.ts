...
export const deepSeekModels = {
	"deepseek-chat": {
		...
		temperature: 0.3, // DeepSeek recommends 0-0.3 for coding tasks, 0.7 for general
	...
	"deepseek-chat-v3.1": {
		...
		inputPrice: 0,
		outputPrice: 0.65,
		cacheWritesPrice: 0.1625,
		cacheReadsPrice: 0.065,
		temperature: 0.7,
		supportsReasoning: false,
		supportsReasoningEffort: false,
		apiFormat: ApiFormat.OPENAI_CHAT,
		supportsTools: true,
		supportsStreaming: true,
		description: "DeepSeek V3.1 — improved reasoning and coding performance over V3.",
	},
	"deepseek-chat-v3.2": {
		maxTokens: 8_000,
		contextWindow: 128_000,
		...
		supportsTools: true,
		supportsStreaming: true,
		description: "DeepSeek V3.2 — hybrid reasoning model with efficient long-context scaling.",
	},
	"deepseek-reasoner": {
		maxTokens: 8_192,
		contextWindow: 128_000,
